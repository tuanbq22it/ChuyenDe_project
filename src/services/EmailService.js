...
class EmailService {
    ...
    async sendSpamCommentAlert(commentData) {
    const emailData = {
      type: 'spam-comment',
      data: {
        comment: commentData.comment || 'No content',
        user: commentData.user || 'Unknown User',
        postTitle: commentData.postTitle || 'Unknown Post'
      }
    };
